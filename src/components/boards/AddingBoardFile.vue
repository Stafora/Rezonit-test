	...
	<div class="adding-board-file">
		...
		<!-- <div class="adding-board-file-progress">
			...
			<div class="adding-board-file-progress-info">
				...
				<div class="adding-board-file-progress-bar">
					<div class="adding-board-file-progress-bar-percent" style="width: 40%;"></div>
				</div>
			</div>
			<div class="adding-board-file-progress-cancel">
