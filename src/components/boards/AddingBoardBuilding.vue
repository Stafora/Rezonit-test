		...
		<div class="adding-board-row">
			<div class="adding-board-col adding-board-col-4">
				...
				<div class="adding-board-select">
					...
					<select name="">
						<option value="">Тип материала базы</option>
						<option value="1">FR1</option>
						<option value="2">FR2</option>
						<option value="3">FR3</option>
				...
				<div class="adding-board-select">
					...
					<select name="">
						<option value="">Толщина платы</option>
						<option value="1">1.0 мм</option>
						<option value="2">1.1 мм</option>
						<option value="3">1.2 мм</option>
						<option value="4">1.3 мм</option>
					</select>
				</div>
				...
				<div class="adding-board-select">
					...
					<select name="">
						<option value="">Толщина фольги</option>
						<option value="1">1 мкм</option>
						<option value="2">2 мкм</option>
						<option value="3">3 мкм</option>
						<option value="4">4 мкм</option>
					</select>
				</div>
