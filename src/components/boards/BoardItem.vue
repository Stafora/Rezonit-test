    ...
    <div class="boards-list-item">
		<router-link :to="`/cards/${card.id}`" class="boards-list-item__title boards-list-item-col">
			<svg width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<defs>
					<linearGradient id="paint0_linear" x1="0.25" y1="9.37433" x2="19.75" y2="9.37433" gradientUnits="userSpaceOnUse">
	...
	export default {
		...
		methods: {
			...
			openSettingMenu: function () {
				const self = this;
				if(this.isOpenSettingMenu === false) {
					setTimeout(function() {
						self.isOpenSettingMenu = true
					}, 0)
				} else {
					self.isOpenSettingMenu = false
				}
			},
			closeSettingMenu() {
				if(this.isOpenSettingMenu === true){
					this.isOpenSettingMenu = false
				}
			},
			deleteItem() {
