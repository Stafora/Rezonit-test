		...
		<form action="" class="registration-form">
			...
			<div class="form-element">
				<div class="form-element-input-wrapper">
					<input type="text" name="name" class="form-element__input" placeholder="Ваше имя" autocomplete="off">
				</div>
			</div>
			<div class="form-element">
				<div class="form-element-input-wrapper">
					<input type="email" name="email" class="form-element__input" placeholder="Введите email" autocomplete="off">
				</div>
			</div>
			<div class="form-element">
				<div class="form-element-input-wrapper">
					<input type="password" name="password" class="form-element__input" placeholder="Придумайте пароль" autocomplete="off">

					<div class="form-element__visible-password">
			...
			<div class="form-element">
				<div class="form-element-input-wrapper">
					<input type="password" name="password-repeated" class="form-element__input" placeholder="Повторите пароль" autocomplete="off">
